    ...
    public class Requirements
    {
        ...
        public Requirements()
        {
            ...
            decoratorreqs.Add(new PatternRequirement("DECORATOR-CONCRETE-METHOD-SETS-PROPERTY", 
                ...
                "The concrete decorator should always call the base constructor so that the base product is set.", 
                "The concrete decorators do not call the abstract decorator's constructor"));
