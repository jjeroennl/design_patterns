...
namespace idetector.Data
{
    public class Requirements
    {
        ...
        public Requirements()
        {
            ...
            decoratorreqs.Add(new PatternRequirement("DECORATOR-BASE-HAS-CHILDREN", "Base classes", "A decorator pattern should contain an interface or abstract class with at least 2 children: 1 base class and an abstract decorator.", "The base interface/abstract did not have any children", "https://en.wikipedia.org/wiki/Decorator_pattern"));
            decoratorreqs.Add(new PatternRequirement("DECORATOR-HAS-CHILDREN", "Abstract decorator implemented", "The abstract decorator class should have at least 1 child which should be the concrete decorator.", "The abstract decorator did not have any children", "https://en.wikipedia.org/wiki/Decorator_pattern"));
            ...
            decoratorreqs.Add(new PatternRequirement("DECORATOR-CONCRETE-METHOD-SETS-PROPERTY", "Concrete decorator sets the base item", "The concrete decorator should always call the base constructor so that the base product is set.", "The concrete decorators do not call the abstract decorator's constructor", "https://en.wikipedia.org/wiki/Decorator_pattern"));
